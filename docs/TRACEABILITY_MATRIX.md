...
|---|---|---:|---|---|---|---|
| AEGIS-001 | Governance | M0 | Frozen canonical specification | implemented | — | tools/check_frozen.py<br>.claude/hooks/protect_spec.py<br>scripts/git-hooks/pre-commit<br>tests/unit/test_frozen_integrity.py<br>tests/unit/test_protect_spec_hook.py |
| AEGIS-002 | Governance | M0 | Requirement traceability | implemented | — | tools/audit_requirements.py<br>tools/generate_traceability.py<br>tests/unit/test_audit_requirements.py<br>docs/TRACEABILITY_MATRIX.md |
| AEGIS-003 | Governance | M0 | Evidence-based completion | implemented | — | tools/audit_requirements.py<br>tools/update_status.py<br>tools/generate_deferred_register.py<br>tests/unit/test_evidence_rules.py<br>docs/DEFERRED_VERIFICATION.md |
...
| AEGIS-005 | Governance | M0 | Determinism before optimization | implemented | M1 | tools/determinism_check.py<br>python/common/determinism.py<br>tests/replay/test_determinism_harness.py<br>experiments/evidence/AEGIS-005/summary.json<br>experiments/evidence/AEGIS-005/canonical_output.txt<br>experiments/evidence/AEGIS-005/run1.hash<br>experiments/evidence/AEGIS-005/run2.hash |
| AEGIS-006 | Governance | M0 | No fabricated claims | implemented | — | tools/check_claims.py<br>configs/claims_policy.yaml<br>tests/unit/test_check_claims.py |
| AEGIS-007 | Governance | M0 | One active milestone | implemented | — | tools/check_scope.py<br>configs/milestone_scope.yaml<br>docs/BUILD_STATE.md<br>tests/unit/test_scope_guard.py |
| AEGIS-008 | Governance | M0 | Decision records | implemented | — | tools/check_adrs.py<br>adr/0001-platform-architecture.md<br>tests/unit/test_check_adrs.py |
...
| AEGIS-010 | Governance | M0 | Secrets isolation | implemented | — | tools/scan_secrets.py<br>configs/secret_scan_allowlist.json<br>.claude/settings.json<br>tests/unit/test_scan_secrets.py<br>tests/unit/test_settings_deny_rules.py |
...
| AEGIS-231 | Engineering Platform | M0 | Configuration system | implemented | — | configs/schemas/config.v1.json<br>python/common/config.py<br>cpp/common/config.cpp<br>tests/unit/test_config_validation.py<br>tests/cpp/unit/test_config.cpp |
| AEGIS-232 | Engineering Platform | M0 | Structured logging | implemented | — | configs/schemas/log_record.v1.json<br>python/common/logging.py<br>cpp/common/logging.cpp<br>tests/unit/test_structured_logging.py<br>tests/cpp/unit/test_logging.cpp |
...
| AEGIS-235 | Engineering Platform | M0 | Documentation | implemented | — | docs/RUNBOOK.md<br>docs/DEMO.md<br>docs/LIMITATIONS.md<br>docs/ENVIRONMENT.md<br>tools/check_docs.py<br>tests/unit/test_check_docs.py |
| AEGIS-236 | Engineering Platform | M0 | Sample data policy | implemented | — | tools/check_sample_data.py<br>tools/check_pack_manifest.py<br>data_samples/PROVENANCE.yaml<br>configs/external_datasets.yaml<br>tests/unit/test_check_sample_data.py |
| AEGIS-237 | Engineering Platform | M0 | Failure recovery | implemented | M3 | python/common/recovery.py<br>docs/RECOVERY_CONTRACT.md<br>tests/unit/test_recovery_contract.py |
