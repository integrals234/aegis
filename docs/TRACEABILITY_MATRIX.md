...
| AEGIS-227 | Engineering Platform | M0 | Modern C++ toolchain | implemented | M1 | CMakeLists.txt<br>CMakePresets.json<br>.clang-tidy<br>.clang-format<br>tests/cpp/unit/test_version.cpp |
...
| AEGIS-233 | Engineering Platform | M0 | Unit, integration, property and replay tests | implemented | M1 | tools/run_test_layers.py<br>pyproject.toml<br>tests/cpp/CMakeLists.txt<br>tests/unit/test_ci_parity.py<br>experiments/evidence/AEGIS-233/test_layers.json |
| AEGIS-234 | Engineering Platform | M0 | Continuous integration | implemented | M1 | .github/workflows/ci.yml<br>scripts/ci_local.sh<br>tests/unit/test_ci_parity.py |
