...
| AEGIS-004 | Governance | M0 | Exchange/participant separation | implemented | M1 | tools/check_architecture.py<br>configs/architecture_rules.yaml<br>tests/unit/test_check_architecture.py |
| AEGIS-005 | Governance | M0 | Determinism before optimization | implemented | M1 | tools/determinism_check.py<br>python/common/determinism.py<br>tests/replay/test_determinism_harness.py<br>experiments/evidence/AEGIS-005/summary.json |
...
| AEGIS-233 | Engineering Platform | M0 | Unit, integration, property and replay tests | implemented | M1 | tools/run_test_layers.py<br>pyproject.toml<br>tests/cpp/CMakeLists.txt<br>tests/unit/test_ci_parity.py |
...
| AEGIS-237 | Engineering Platform | M0 | Failure recovery | implemented | M1 | python/common/recovery.py<br>docs/RECOVERY_CONTRACT.md<br>tests/unit/test_recovery_contract.py |
| AEGIS-238 | Engineering Platform | M0 | Observability | implemented | M1 | python/common/metrics.py<br>tests/integration/test_metrics_registry.py |
